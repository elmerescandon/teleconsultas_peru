...
import {dateToSpanishISO, stringToDate} from "@/utils/functions/utils";
...
const PaymentReview = ({appointment}: PaymentReviewProps) => {
  ...
  }, [appointment, doctorId, specialityId]);

  return (
    <div className="w-full h-full max-lg:w-full max-lg:h-full">
      ...
      <div>
        ...
        <PaymentItem label="Fecha" name={(date && dateToSpanish(date)) || ""} />
        <PaymentItem
          label="Horario"
          name={
