...
const Footer = () => {
  return (
    <div
      className="flex flex-row bg-salufy-blue px-48 py-14 flex-shrink-0 flex-grow
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-1">
          ...
          <LinkSecondary2 to={""}>soporte@salufyorg.com</LinkSecondary2>
      ...
      <div className="flex flex-col gap-2 px-14 max-lg:px-0 max-xl:items-center">
        <Image
